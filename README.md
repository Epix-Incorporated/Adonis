...
3. Adonis may fail to load due if script restrictions are enabled for the loader. If this happens disable the `.Sandboxed` property for all the Adonis loader assets and enable `Load Third Party Assets` in the Game Settings.
