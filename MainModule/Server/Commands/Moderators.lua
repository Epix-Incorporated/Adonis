	...
	return {
		...
		Message = {
			...
			Function = function(plr: Player, args: {string})
				...
				Functions.Message(plr, "Message from ".. service.FormatPlayer(plr), service.BroadcastFilter(args[1], plr), 'HeadShot', service.GetPlayers(), true, nil)
			end
		};
		...
		MessagePM = {
			...
			Function = function(plr: Player, args: {string})
				...
				for _, v in service.GetPlayers(plr, args[1]) do
					Functions.Message(plr, Sender, service.Filter(args[2], plr, v), 'HeadShot', {v}, true)
				end
			end
		};
		...
		JoinServer = {
			...
			Function = function(plr: Player, args: {string})
				...
				Functions.Message(nil, "Adonis", "Teleporting to server \""..args[2].."\"\nPlease wait...", nil, players, false, 10)
			end
		};
