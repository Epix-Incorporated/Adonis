	...
	return {
		...
		Repeat = {
			...
			Function = function(plr,args)
				...
				assert(command, "Must supply command to repeat (Argument #1 needs to be supplied)")
		...
		SetTeam = {
			...
			AdminLevel = "Moderators";
			Function = function(plr,args)
				assert(args[1], "You need to specify a player name name (Argument missing or nil)")
