...
local function main()
	...
	Properties.SoundPreviewProp = {Category = "Data", ValueType = {Name = "SoundPlayer"}, Class = "Sound", Name = "Preview", Tags = {}, IsSoundPreview = true,}
	...
	Properties.GetExpandedProps = function(prop) -- TODO: Optimize using table
		...
		if (prop.Name == "SoundId" and prop.Class == "Sound") or (prop.Name == "Asset" and prop.Class == "AudioPlayer") then
			local preview = {}
			local preview = {}
			for k,v in pairs(Properties.SoundPreviewProp) do preview[k] = v end
	...
	Properties.SetSoundPreview = function(soundObj:Sound?,noplay:boolean)
		...
		if not soundObj then
			...
			if newId then
				for _,v in ipairs(sound:GetChildren()) do v:Destroy() end
