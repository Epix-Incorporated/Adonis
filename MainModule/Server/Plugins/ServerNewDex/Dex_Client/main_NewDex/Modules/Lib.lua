...
local function main()
	...
	Lib.Signal = (function()
		...
		funcs.Fire = function(self, ...)
			for i, v in next, self.Connections do
				task.spawn(xpcall, v.Func, function(e)
					warn(e .. "\n" .. debug.traceback())
				end, ...)
			end
		end
			...
			scrollThumbFrame.InputBegan:Connect(function(input)
				if
					(
						input.UserInputType ~= Enum.UserInputType.MouseButton1
						and input.UserInputType ~= Enum.UserInputType.Touch
					) or checkMouseInGui(scrollThumb)
				then
					return
				end
	...
	Lib.Window = (function()
		...
		static.Init = function()
			...
			indicator.Parent = alignIndicator
			...
			local contextGui = create({
				{
					1,
					"ScreenGui",
					{ DisplayOrder = 1000000, Name = "Dex_Context", ZIndexBehavior = 1, ResetOnSpawn = false },
				},
				{
					2,
					"Frame",
	...
	Lib.NumberSequenceEditor = (function()
		local function new() -- TODO: Convert to newer class model
			...
			local envelopeDragLine = Instance.new("Frame")
			envelopeDragLine.Parent = envelopeDrag
