return {
	...
	"";
	"[v241 2023-12-20 23:59 UTC] @Dimenpsyonal & @ccuser44";
	...
	"(Git/coasterteam) Coasterteam various fixes and improvements (#1242)";
	"(Git/chesse20) Remove dropper from loader (#1238)";
	"(Git/ccuser44) Remove dropper artifacts, fix Adonis being totally broken (#1280)";
	"(Git/ccuser44) :clone and :loadavatar are now the same command (#1198)";
	"(Git/ccuser44) Add TextChatService support for command and command autocompletion (#1208)";
	"(Git/ccuser44) Add :sing command (#1217)";
	"(Git/kaiserandaxl) Add new BanMenu UI; add functions+data models to the window code (#1295)";
	"(Git/karl-police) :vote command is now in random order (#1179)";
	"(Git/ccuser44) Add :orderedvote command for voting in order (#1179)";
	...
	"(Git/SuperCater) Fixed :stickify (#1293)";
