return {
	...
	"";
	"[v241 2023-12-18 16:00 UTC] @Dimenpsyonal";
	...
	"Disable protections superseded by RejectCharacterDeletions on new games by @ccuser44 (#1245)";
	"Move GoodSignal from Service.lua to its own file by @ccuser44 (#1244)";
	"Fix Singer.lua runcontext by @ccuser44";
	"Fix odd issue caused by Adonis parenting Service.lua to Server by @ccuser44 (#1248)";
	"Add :outfit command by @wilsontulus (#1228)";
	"Revert 'Add some more non-chad exploits to detections (#1174)' by @Dimenpsyonal (#1252)";
	"Fix :creeper with non-default character sizes and proportions by @ccuser44 (#1250,1254,1255)";
	"Fix broken help button with Mobilius theme by @ccuser44 (#1253)";
	"Fix issue with Admin.RunCommand causing a lot of commands to break by @ccuser44";
	"Change to repository pipeline by @moo1210 (#1263)";
	"Upgrade TrackTask on older functions by @fxeP1 (#1264)";
	"Fix softshutdown failing and not retrying by @ccuser44 (#1261)";
	"Fix to zombie detection by @ccuser44 (#1260)";
	"Show users device on exploitlogs for better analytics by @ccuser44 (#1224)";
	"Fix longstanding issue with :bot animations not working with R15 by @ccuser44 (#1259)";
	"Fix tornado, anti, :buyitem, fpslocker, van, :slippery by @ccuser44 (#1270)";
	"Convert deprecated/legacy items by @ccuser44 (#1270)";
	"Better way of checking soundId for AntiCheat by @wilsontulus (#1235)";
	"Fix arguments for NoYield function; fix :sing command MeshID by @ccuser44 (#1273)";
	"Add Fresh Meat sound from Diablo 1 to :clown by @ccuser44 (#1272)";
	"Add backwards compatibility code to a dedicated plugin by @ccuser44 (#1269)";
	"Merge chargear and plrgear by @ccuser44 (#1271)";
	"Fix wrong tool position and clipping in to baseplate by @ccuser44 (#1271)";
	"Add particles to trigger by @ccuser44 (#1274)";
	"Add cPcall to task.spawn by @ccuser44 (#1277)";
	"Remove legacy CylinderMeshes from UFO by @ccuser44 (#1278)";
	"Fix :spin by @ccuser44 (#1276)";
	"Add R6 versions of AnimatedFaces and fix sing again by @ccuser44 (#1275)";
	"Update ServerNewDex Plugin, with new features by @karl-police (#1169)";
	"Delete Loader/Loader/Dropper.server.lua by @chesse20 (#1238)";
	"Remove dropper artifacts, fix Adonis being totally broken by @ccuser44 (#1280)";
	"Fix Adonis being bricked for a long time (fixes crosserver issue) by @ccuser44 (#1284)";
	"Fix odd issue by @ccuser44 (#1283)";
	"Optimise assert, fix webpanel debug, fix gamegravity default, fix TimeHint by @ccuser44 (#1281)";
	"Remove linkedlist toggle in userfacing settings by @ccuser44 (#1288)";
	"Move AutoClean to Miscfeatures plugin by @ccuser44 (#1291)";
	"Remove cPcall by @ccuser44 (#1290)";
	"Fix chargear not working in r6 by @WalkerOfBacon (#1286)";
	"Fixed :stickify by @SuperCater (#1293)";
