...
return function(Vargs, GetEnv)
	...
	CheckDate = function(day, month) -- Support for all timezones
		local t1, t2, t3 = DateTime.fromUnixTimestamp(os.time()):ToUniversalTime(), DateTime.fromUnixTimestamp(os.time() - 13*60*60):ToUniversalTime(), DateTime.fromUnixTimestamp(os.time() + 15*60*60):ToUniversalTime()
